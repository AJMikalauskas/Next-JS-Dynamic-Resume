                  ...
                  <ul>
                    <li className="inline-block text-sky-700 font-semibold border-b-2 border-b-sky-700">
                      ...
                      <p className="inline-block">
                        {fillInData?.singleFields[1].text.split(";")[0]}
                      </p>
                    </li>
                    {/* Make into mail icon? */}
                ...
                <div className="">
                  ...
                  <div className="mt-6">
                    ...
                    <p className="text-sky-700 font-semibold text-sm">
                      {fillInData?.singleFields[0].text.split(",")[1]} |{" "}
                      {fillInData?.singleFields[0].text.split(",")[0]}
                    </p>
                    <div className="text-xs" style={{ fontSize: "10px" }}>
                      <ul>
                        <li>
                            ...
                            <li className="pb-4">
                              <div className="flex">
                                ...
                                <div className="text-xs pt-1.5 pl-2 ">
                                  (
                                  <span className="text-sky-700 hover:underline cursor-pointer font-semibold">
                                    <a href={fillInData?.otherProjects[1].link}>
                                      Demo
                                    </a>
                                  </span>
                                  )<span> - </span>(
                            ...
                            <li>
                              <div className="flex">
                                ...
                                <div className="text-xs pt-1.5 pl-2 ">
                                  (
                                  <span className="text-sky-700 hover:underline cursor-pointer font-semibold">
                                    <a href={fillInData?.otherProjects[0].link}>
                                      Demo
                                    </a>
                                  </span>
                                  )<span> - </span>(
                  ...
                  <div className="border border-gray-300 rounded-md">
                    ...
                    >
                      <div className="accordion-item border-t-0 border-l-0 border-r-0 rounded-none bg-white border border-gray-200">
                        <h2
                          className="accordion-header mb-0 border-t-2"
                          id="headingOne5"
                        >
                          <button
