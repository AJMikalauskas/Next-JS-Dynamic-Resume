          ...
          <div className="rounded-md justify-center mx-auto bg-no-repeat bg-cover bg-center custom-img relative h-[92.25vh] w-[63%]">
            <div className="rounded-md bg-[#000]/50 p-4 text-white relative max-h-[85vh] overflow-y-scroll hide-scrollbar">
              <div className="rounded-md bg-[#fff]/50 h-8 text-center">
                ...
                <p className="pt-1.5">{fillInData?.singleFields[2].text}</p>
              </div>
              ...
              <div className="mt-4 ">
                    ...
                    <span className="float-right mr-10">
                      ...
                      {proj1Showing ? (
                        <AiOutlineCaretUp
                          ...
                          onClick={() => setProj1Showing(!proj1Showing)}
                        />
                      ) : (
                        <AiOutlineCaretDown
                          size="25px"
                ...
                <div className={`${proj1Showing ? "" : "hidden"}`}>
                  <ul
                    style={{ listStyle: "disc", fontSize: "12px" }}
                    className="float-right pl-20 text-sm pb-4"
                  >
                    {fillInData?.projects[0].explanationBulletPoints
                      .split(".")
                      .map((bp, idx) => (
                        <li key={idx}>{bp}</li>
                      ))}
                  ...
                  <p className="text-sm mx-4 ">
                    ...
                    {fillInData?.projects[0].techStack}
                  </p>
                </div>
              </div>
              {/* 2nd Project */}
              <div className="mt-4">
                <div className="">
                  ...
                  <div>
                    <span className="font-extralight text-sm">
                      ...
                      <a
                        href={fillInData?.projects[1].link}
                        className="text-sky-300 hover:underline"
                        target="_blank"
                        rel="noreferrer"
                      >
                      ...
                      <a
                        href={fillInData?.projects[1].github}
                        className="text-sky-300 hover:underline"
                        target="_blank"
                        rel="noreferrer"
                      >
                    ...
                    <span className="float-right mr-10">
                      ...
                      {proj2Showing ? (
                        <AiOutlineCaretUp
                          size="25px"
                          className="hover:cursor-pointer"
                          onClick={() => setProj2Showing(!proj2Showing)}
                        />
                      ) : (
                        <AiOutlineCaretDown
                          size="25px"
                ...
                <div className={`${proj2Showing ? "" : "hidden"}`}>
                  ...
                  >
                    ...
                    {fillInData?.projects[1].explanationBulletPoints
                      .split(".")
                      .map((bp, idx) => (
                        <li key={idx}>{bp}</li>
                      ))}
                      ...
                      <span className="float-right">
                        ...
                        {frontendSkillsShowing ? (
                          <AiOutlineCaretUp
                            ...
                            className="hover:cursor-pointer"
                            onClick={() =>
                              setFrontendSkillsShowing(!frontendSkillsShowing)
                            }
                          />
                        ) : (
                          <AiOutlineCaretDown
                      ...
                      <ul className="text-left dropdown-menu-1 ">
                        {fillInData?.skills[0].skills.map(
                          (skill: string, idx: number) => (
                            <li
                              key={idx}
                              className={`list-item-${idx} bg-[#fff]/30 px-2`}
                            >
                              {skill}
                            </li>
                          )
                  ...
                  <div>
                      ...
                      <span className="float-right">
                        ...
                        {backendSkillsShowing ? (
                          <AiOutlineCaretUp
                            ...
                            className="hover:cursor-pointer"
                            onClick={() =>
                              setBackendSkillsShowing(!backendSkillsShowing)
                            }
                          />
                        ) : (
                          <AiOutlineCaretDown
                    ...
                    <div
                      className={`rounded-sm ${
                        !backendSkillsShowing && "hidden"
                      }`}
                    >
                      <ul className="text-left dropdown-menu-2">
                        {fillInData?.skills[2].skills.map(
                          (skill: string, idx: number) => (
                            <li key={idx} className="bg-[#fff]/30 px-2">
                              {skill}
                            </li>
                          )
                        )}
              ...
              <div className="mt-6">
                  ...
                  <div className="rounded-sm bg-[#fff]/30 text-left font-bold h-[60px]">
                    ...
                    <div className="pt-2">
                      ...
                      <span className="float-right mr-2 mt-3">
                        <a
                          href={fillInData?.otherProjects[1].link}
                          target="_blank"
                          rel="noreferrer"
                        >
                      ...
                      <div className="text-xs">
                        ...
                        <a
                          href={fillInData?.otherProjects[1].github}
                          className="hover:underline text-sky-300"
                          target="_blank"
                          rel="noreferrer"
                        >
                ...
                <div className="rounded-sm bg-[#fff]/30 text-left font-bold h-[60px] mt-4">
                  ...
                  <div className="pt-2">
                    ...
                    <span className="float-right mr-2 mt-3">
                      <a
                        href={fillInData?.otherProjects[0].link}
                        target="_blank"
                        rel="noreferrer"
                      >
                        <AiOutlineCaretRight size="25px" />
                    ...
                    <div className="text-xs">
                      ...
                      <a
                        href={fillInData?.otherProjects[0].github}
                        className="hover:underline text-sky-300"
                        target="_blank"
                        rel="noreferrer"
                      >
            ...
            <div className="absolute bottom-0 bg-[#000]/60 w-full overflow-hidden h-[5%] flex py-1 justify-evenly">
              <div className="hover:cursor-pointer">
                ...
                <Link href="/">
                  <Image
                    ...
                    alt="windows-11-icon"
                    width={35}
                    className="items-center flex hover:bg-white/40 rounded-md"
                  />
                </Link>
              </div>
              ...
              <AiOutlineSearch
                size="35px"
                className="text-white items-center flex hover:bg-white/40 rounded-md"
              />
              ...
              />
              <a
                href="https://www.linkedin.com/in/alexander-mikalauskas/"
                target="_blank"
                rel="noreferrer"
              >
                <Image
              ...
              <a
                href="https://github.com/AJMikalauskas"
                target="_blank"
                rel="noreferrer"
              >
                <Image
